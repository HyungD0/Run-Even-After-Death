...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""PlayerDieSelf"",
            ""id"": ""8763cdae-62db-463a-8737-47923322603d"",
            ""actions"": [
                {
                    ""name"": ""Die"",
                    ""type"": ""Button"",
                    ""id"": ""20552181-9ba5-495d-8841-77b69a985003"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
    ...
    ""controlSchemes"": [
        ...
        // PlayerDieSelf
        m_PlayerDieSelf = asset.FindActionMap("PlayerDieSelf", throwIfNotFound: true);
        m_PlayerDieSelf_Die = m_PlayerDieSelf.FindAction("Die", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_PlayerDieSelf.enabled, "This will cause a leak and performance issues, InputSystem_Actions.PlayerDieSelf.Disable() has not been called.");
    }
    ...
    // PlayerDieSelf
    private readonly InputActionMap m_PlayerDieSelf;
    private List<IPlayerDieSelfActions> m_PlayerDieSelfActionsCallbackInterfaces = new List<IPlayerDieSelfActions>();
    private readonly InputAction m_PlayerDieSelf_Die;
    /// <summary>
    /// Provides access to input actions defined in input action map "PlayerDieSelf".
    /// </summary>
    public struct PlayerDieSelfActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerDieSelfActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "PlayerDieSelf/Die".
        /// </summary>
        public InputAction @Die => m_Wrapper.m_PlayerDieSelf_Die;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_PlayerDieSelf; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="PlayerDieSelfActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(PlayerDieSelfActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="PlayerDieSelfActions" />
        public void AddCallbacks(IPlayerDieSelfActions instance)
        {
            if (instance == null || m_Wrapper.m_PlayerDieSelfActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PlayerDieSelfActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="PlayerDieSelfActions" />
        private void UnregisterCallbacks(IPlayerDieSelfActions instance)
        {
            @Die.started -= instance.OnDie;
            @Die.performed -= instance.OnDie;
            @Die.canceled -= instance.OnDie;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="PlayerDieSelfActions.UnregisterCallbacks(IPlayerDieSelfActions)" />.
        /// </summary>
        /// <seealso cref="PlayerDieSelfActions.UnregisterCallbacks(IPlayerDieSelfActions)" />
        public void RemoveCallbacks(IPlayerDieSelfActions instance)
        {
            if (m_Wrapper.m_PlayerDieSelfActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="PlayerDieSelfActions.AddCallbacks(IPlayerDieSelfActions)" />
        /// <seealso cref="PlayerDieSelfActions.RemoveCallbacks(IPlayerDieSelfActions)" />
        /// <seealso cref="PlayerDieSelfActions.UnregisterCallbacks(IPlayerDieSelfActions)" />
        public void SetCallbacks(IPlayerDieSelfActions instance)
        {
            foreach (var item in m_Wrapper.m_PlayerDieSelfActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PlayerDieSelfActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="PlayerDieSelfActions" /> instance referencing this action map.
    /// </summary>
    public PlayerDieSelfActions @PlayerDieSelf => new PlayerDieSelfActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "PlayerDieSelf" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="PlayerDieSelfActions.AddCallbacks(IPlayerDieSelfActions)" />
    /// <seealso cref="PlayerDieSelfActions.RemoveCallbacks(IPlayerDieSelfActions)" />
    public interface IPlayerDieSelfActions
    {
        /// <summary>
